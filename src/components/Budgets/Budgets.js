...
export class Budgets extends Component {
    ...
    renderColumnHeader = () => {
        ...
        return <div className="row col-header">
                {arr}
        </div>;
    }
    ...
    renderColumns = (category) => {
        ...
        return <div key={category.id} className="row">
            {arr}
        </div>;
    }
    ...
    render() {
        ...
        return (
            <Modal onClose={this.props.onClose} title={'מבט שנתי'}>
                <div className="Budgets-container">
                    ...
                    <div className="second">
                        ...
                        {
                            categories.map((category, index) => this.renderColumns(category, index))
                        }
                    </div>
                </div>
            </Modal>

...
import { getIsRTL, getLanguage } from "../i18n/language";
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <div className="row">
                    <div>
                        <div className="question">{i18n.QUESTION_NO_USER}</div>
                        <Link to="/join">{i18n.LINK_JOIN}</Link>
                    </div>
                    <div>
                        ...
                        <Link to="/reset">{i18n.LINK_RESET}</Link>
                    </div>
                </div>
            </div>
        );
